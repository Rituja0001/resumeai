...
ALLOWED_HOSTS = list(set([h.strip() for h in allowed_hosts_env.split(",") if h.strip()] + ["localhost", "127.0.0.1", "testserver", ".onrender.com", "resumeai-backend-kzcn.onrender.com"]))
