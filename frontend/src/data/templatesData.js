 ...
 * 50 high-fidelity, ATS-optimized resume templates with rich Indian career context.
 */
...
export const TEMPLATES = [
  // ---------------------------------------------------------------------------
  // 1 - 10: Engineering, Senior Tech, & Cloud Systems
  // ---------------------------------------------------------------------------
  {
    id: "puffin",
    name: "Puffin",
    ...
    sampleEducation: [
      { institution: "IIT Madras", degree: "B.Tech in Computer Science", year: "2019" },
    ],
    sampleSkills: ["Go", "Kubernetes", "Kafka", "PostgreSQL", "AWS", "Redis"],
  },

  {
    ...
    sampleEducation: [
      { institution: "NIT Trichy", degree: "B.Tech in Electronics & Comm.", year: "2020" },
    ],
    sampleSkills: ["React", "TypeScript", "Node.js", "GraphQL", "Docker", "Tailwind CSS"],
  },

  {
    ...
    name: "Stonefly",
    category: "Senior",
    tags: ["Senior", "Executive", "Engineer"],
    ...
    sampleEducation: [
      { institution: "IIT Bombay", degree: "M.Tech in Computer Science", year: "2012" },
    ],
    sampleSkills: ["Org Leadership", "Cloud Security", "Fintech Scale", "Microservices", "System Architecture"],
  },

  {
    ...
    sampleEducation: [
      { institution: "COEP Pune", degree: "B.Tech in Computer Engineering · 8.9 CGPA", year: "2023" },
    ],
    sampleSkills: ["Java", "Python", "Spring Boot", "MySQL", "Git", "REST APIs"],
  },

  {
    ...
    sampleEducation: [
      { institution: "ISI Kolkata", degree: "M.Stat in Quantitative Economics", year: "2017" },
    ],
    sampleSkills: ["Python", "PyTorch", "MLOps", "Spark", "SQL", "LLM Fine-Tuning"],
  },

  {
    ...
    accentColor: "#B45309",
    sampleMetrics: ["+52% D30 Retention", "₹38Cr ARR Added"],
    ...
    sampleEducation: [
      { institution: "IIM Ahmedabad", degree: "MBA in Strategy & Marketing", year: "2018" },
    ],
    sampleSkills: ["Product Strategy", "Growth Loops", "A/B Testing", "Mixpanel", "SQL", "User Research"],
  },

  {
    ...
    sampleEducation: [
      { institution: "NID Ahmedabad", degree: "Master of Design (Interaction Design)", year: "2018" },
    ],
    sampleSkills: ["Figma", "Design Systems", "Interaction Design", "User Testing", "Prototyping", "HTML/CSS"],
  },

  {
    ...
    sampleEducation: [
      { institution: "MICA Ahmedabad", degree: "PGDM in Digital Marketing", year: "2017" },
    ],
    sampleSkills: ["Performance Marketing", "Meta Ads", "Google Ads", "Clevertap", "Attribution Modeling", "SEO"],
  },

  {
    ...
    sampleEducation: [
      { institution: "Symbiosis Pune", degree: "MBA in International Business", year: "2016" },
    ],
    sampleSkills: ["Enterprise SaaS", "MEDDIC Sales", "Contract Negotiation", "Revenue Pipeline", "Salesforce CRM"],
  },

  {
    ...
    sampleEducation: [
      { institution: "IIT Delhi", degree: "B.Tech in Mechanical Engineering", year: "2009" },
    ],
    sampleSkills: ["P&L Management", "Supply Chain", "Operational Scale", "Unit Economics", "Board Governance"],
  },

  // ---------------------------------------------------------------------------
  // 11 - 20: Engineering, Data & Full-Stack Developers
  // ---------------------------------------------------------------------------
  {
    id: "falcon",
    name: "Falcon",
    ...
    sampleEducation: [
      { institution: "DTU Delhi", degree: "B.Tech in Information Technology", year: "2018" },
    ],
    sampleSkills: ["AWS", "Terraform", "Kubernetes", "Docker", "Ansible", "Prometheus", "CI/CD"],
  },

  {
    ...
    sampleEducation: [
      { institution: "Jadavpur University", degree: "B.E. in Computer Science", year: "2022" },
    ],
    sampleSkills: ["React", "Next.js", "JavaScript (ES6+)", "Redux Toolkit", "WebSockets", "CSS Modules"],
  },

  {
    ...
    sampleEducation: [
      { institution: "RVCE Bengaluru", degree: "B.E. in Information Science", year: "2019" },
    ],
    sampleSkills: ["Snowflake", "dbt", "Apache Spark", "Airflow", "Python", "SQL", "Flink"],
  },

  {
    ...
    sampleEducation: [
      { institution: "IIT Roorkee", degree: "B.Tech in Computer Science", year: "2015" },
    ],
    sampleSkills: ["System Design", "Distributed Ledgers", "gRPC", "Java / Spring", "Kafka", "Elasticsearch"],
  },

  {
    ...
    layoutStyle: "sidebar-right",
    accentColor: "#B45309",
    sampleMetrics: ["3.2M MAUs", "₹16Cr ARR"],
    ...
    sampleEducation: [
      { institution: "IIIT Hyderabad", degree: "B.Tech + MS in Computer Science", year: "2018" },
    ],
    sampleSkills: ["Technical Product", "ML Discovery", "User Funnels", "Product Roadmapping", "SQL", "Jira"],
  },

  {
    ...
    sampleEducation: [
      { institution: "IDC School of Design, IIT Bombay", degree: "B.Des in Interaction Design", year: "2023" },
    ],
    sampleSkills: ["Figma", "User Research", "Wireframing", "Usability Testing", "Design Systems", "Webflow"],
  },

  {
    ...
    sampleEducation: [
      { institution: "St. Xavier's College, Mumbai", degree: "B.A. in Mass Communication", year: "2019" },
    ],
    sampleSkills: ["SEO Strategy", "Content Marketing", "Brand Storytelling", "Copywriting", "Ahrefs", "Google Analytics"],
  },

  {
    ...
    sampleEducation: [
      { institution: "Rajagiri School of Management", degree: "MBA in Marketing", year: "2019" },
    ],
    sampleSkills: ["B2B SaaS Sales", "HubSpot CRM", "Demo Mastery", "Pipeline Management", "Contract Closing"],
  },

  {
    ...
    sampleEducation: [
      { institution: "XLRI Jamshedpur", degree: "PGDM in Human Resource Management", year: "2008" },
    ],
    sampleSkills: ["Strategic HR", "Org Design", "Talent Acquisition", "Compensation & Benefits", "Leadership Succession"],
  },

  {
    ...
    sampleEducation: [
      { institution: "DA-IICT Gandhinagar", degree: "B.Tech in Information & Comm. Tech", year: "2023" },
    ],
    sampleSkills: ["SQL", "Python", "Tableau", "Power BI", "Excel / Financial Modeling", "BigQuery"],
  },

  // ---------------------------------------------------------------------------
  // 21 - 30: Product, Marketing, Sales & Creative Templates
  // ---------------------------------------------------------------------------
  {
    id: "lapwing",
    name: "Lapwing",
    ...
    layoutStyle: "sidebar-right",
    accentColor: "#FA0C40",
    sampleMetrics: ["14M Active Users", "4.8★ App Store"],
    ...
    sampleEducation: [
      { institution: "BITS Pilani", degree: "B.E. in Electrical & Electronics", year: "2018" },
    ],
    sampleSkills: ["Fintech Payments", "UPI Architecture", "Conversion Funnels", "Product Discovery", "Mixpanel"],
  },

  {
    ...
    sampleEducation: [
      { institution: "Srishti Institute of Art, Design and Technology", degree: "B.Des in Visual Communication", year: "2019" },
    ],
    sampleSkills: ["UI Design", "Figma", "Design Systems", "Protopie", "Adobe Illustrator", "3D Blender"],
  },

  {
    ...
    sampleEducation: [
      { institution: "FMS Delhi", degree: "MBA in Marketing", year: "2014" },
    ],
    sampleSkills: ["Brand Marketing", "IPL Partnerships", "Omnichannel Growth", "Performance ROI", "Team Leadership"],
  },

  {
    ...
    sampleEducation: [
      { institution: "TAPMI Manipal", degree: "PGDM in Sales & Marketing", year: "2015" },
    ],
    sampleSkills: ["B2B SaaS", "MEA Expansion", "Enterprise Negotiation", "C-Level Relationships", "Sales Leadership"],
  },

  {
    ...
    sampleEducation: [
      { institution: "NSUT Delhi", degree: "B.Tech in Computer Engineering", year: "2020" },
    ],
    sampleSkills: ["Golang", "Python", "AWS DynamoDB", "Docker", "REST APIs", "Redis"],
  },

  {
    ...
    sampleEducation: [
      { institution: "IIT Kanpur", degree: "B.Tech in Mathematics & Computing", year: "2016" },
    ],
    sampleSkills: ["Quantitative Modeling", "Python", "C++", "Monte Carlo", "Risk Analytics", "SQL"],
  },

  {
    ...
    sampleEducation: [
      { institution: "Osmania University", degree: "B.A. in English & Mass Comm.", year: "2023" },
    ],
    sampleSkills: ["Social Media", "Instagram Reels", "Canva", "Copywriting", "Community Building", "Analytics"],
  },

  {
    ...
    sampleEducation: [
      { institution: "ICAI India", degree: "Chartered Accountant (Rank Holder)", year: "2006" },
    ],
    sampleSkills: ["IPO Execution", "M&A", "Corporate Governance", "Treasury & Capital Structure", "Investor Relations"],
  },

  {
    ...
    sampleEducation: [
      { institution: "IIT Guwahati", degree: "B.Des in Design", year: "2017" },
    ],
    sampleSkills: ["Interaction Design", "Figma", "Micro-Interactions", "User Psychology", "Mobile UI", "Prototyping"],
  },

  {
    ...
    sampleEducation: [
      { institution: "IIT Kharagpur", degree: "B.Tech in Computer Science", year: "2019" },
    ],
    sampleSkills: ["vLLM", "Triton", "PyTorch", "Kubernetes", "Ray", "Docker", "Python"],
  },

  // ---------------------------------------------------------------------------
  // 31 - 40: Senior Executives, Data Science, Sales & Engineering
  // ---------------------------------------------------------------------------
  {
    id: "barbet",
    name: "Barbet",
    ...
    sampleEducation: [
      { institution: "IIT Bombay", degree: "B.Tech in Electrical Engineering", year: "2008" },
    ],
    sampleSkills: ["Live Video Streaming", "Extreme Concurrency", "Cloud Scale", "Org Building", "Technical Vision"],
  },

  {
    ...
    layoutStyle: "sidebar-right",
    accentColor: "#FA0C40",
    sampleMetrics: ["₹45Cr GMV", "99.9% Delivery SLA"],
    ...
    sampleEducation: [
      { institution: "SPJIMR Mumbai", degree: "PGDM in Supply Chain & Operations", year: "2018" },
    ],
    sampleSkills: ["Quick Commerce", "Route Optimization", "Supply Chain Product", "Data Modeling", "Agile Leadership"],
  },

  {
    ...
    sampleEducation: [
      { institution: "NMIMS Mumbai", degree: "MBA in Marketing", year: "2015" },
    ],
    sampleSkills: ["Fintech APIs", "Enterprise B2B", "Contract Negotiation", "C-Suite Pitching", "Sales Strategy"],
  },

  {
    ...
    sampleEducation: [
      { institution: "MICA Ahmedabad", degree: "PGDM in Communications", year: "2018" },
    ],
    sampleSkills: ["D2C E-Commerce", "WhatsApp Commerce", "Retention Marketing", "Meta Ads", "Shopify Plus", "Klaviyo"],
  },

  {
    ...
    sampleEducation: [
      { institution: "VJTI Mumbai", degree: "B.Tech in Computer Engineering", year: "2017" },
    ],
    sampleSkills: ["Swift", "Kotlin", "React Native", "iOS SDK", "App Performance", "CI/CD Fastlane"],
  },

  {
    ...
    sampleEducation: [
      { institution: "Heritage Institute of Technology", degree: "B.Tech in Computer Science · 9.1 CGPA", year: "2023" },
    ],
    sampleSkills: ["Node.js", "Express", "PostgreSQL", "GraphQL", "TypeScript", "Docker", "Git"],
  },

  {
    ...
    sampleEducation: [
      { institution: "Indraprastha University (IPU)", degree: "B.Tech in Artificial Intelligence", year: "2023" },
    ],
    sampleSkills: ["Python", "Pandas", "Scikit-Learn", "XGBoost", "SQL", "Tableau", "Git"],
  },

  {
    ...
    sampleEducation: [
      { institution: "IIT Madras", degree: "B.Tech + M.Tech in Computer Science", year: "2004" },
    ],
    sampleSkills: ["Connected Vehicle OS", "Patents & IP", "Global Engineering", "AI Strategy", "Executive Leadership"],
  },

  {
    ...
    sampleEducation: [
      { institution: "IIT Kanpur", degree: "Master of Design (M.Des)", year: "2016" },
    ],
    sampleSkills: ["Ethnographic Research", "Usability Labs", "Behavioral Heuristics", "Survey Design", "Figma", "User Journey Mapping"],
  },

  {
    ...
    sampleEducation: [
      { institution: "Amrita Vishwa Vidyapeetham", degree: "B.Tech in Cybersecurity", year: "2017" },
    ],
    sampleSkills: ["Cloud Security", "DevSecOps", "Penetration Testing", "AWS Security", "Kubernetes Hardening", "ISO 27001"],
  },

  // ---------------------------------------------------------------------------
  // 41 - 50: Specialized Professional & High-Performance Templates
  // ---------------------------------------------------------------------------
  {
    id: "booby",
    name: "Booby",
    ...
    sampleEducation: [
      { institution: "Delhi University", degree: "Bachelor of Commerce (Honours)", year: "2021" },
    ],
    sampleSkills: ["Outbound Prospecting", "Salesforce", "LinkedIn Sales Navigator", "Cold Emailing", "Lead Qualification"],
  },

  {
    ...
    layoutStyle: "sidebar-right",
    accentColor: "#BE123C",
    sampleMetrics: ["+180% SEO Traffic", "3.8x ROAS"],
    ...
    sampleEducation: [
      { institution: "Madras Christian College", degree: "B.Sc in Statistics", year: "2018" },
    ],
    sampleSkills: ["Technical SEO", "Programmatic SEO", "Google Search Console", "Ahrefs", "Content Strategy", "Conversion Optimization"],
  },

  {
    ...
    sampleEducation: [
      { institution: "BITS Pilani", degree: "M.Sc in Information Systems", year: "2017" },
    ],
    sampleSkills: ["PostgreSQL", "Cassandra", "Redis", "Database Sharding", "High Availability", "Linux Kernel Tuning"],
  },

  {
    ...
    sampleEducation: [
      { institution: "Symbiosis Institute of Design", degree: "B.Des in User Experience Design", year: "2023" },
    ],
    sampleSkills: ["Figma", "Interaction Design", "Wireframing", "User Research", "Adobe XD", "Typography"],
  },

  {
    ...
    sampleEducation: [
      { institution: "IISc Bengaluru", degree: "Ph.D. in Artificial Intelligence", year: "2017" },
    ],
    sampleSkills: ["PyTorch", "Hugging Face Transformers", "Indic NLP", "Speech Recognition", "CUDA", "Research Publications"],
  },

  {
    ...
    sampleEducation: [
      { institution: "IIM Calcutta", degree: "PGDM in Business Administration", year: "2007" },
    ],
    sampleSkills: ["CRO Leadership", "Global Enterprise Sales", "Net Revenue Retention", "GTM Strategy", "Channel Partnerships"],
  },

  {
    ...
    sampleEducation: [
      { institution: "IIT Kharagpur", degree: "B.Tech in Industrial Engineering", year: "2022" },
    ],
    sampleSkills: ["PRD Writing", "User Telemetry", "A/B Testing", "Mixpanel", "SQL", "Agile Sprints"],
  },

  {
    ...
    layoutStyle: "sidebar-right",
    accentColor: "#B45309",
    sampleMetrics: ["118% Net Retention", "96% CSAT Score"],
    ...
    sampleEducation: [
      { institution: "Symbiosis Centre for Management", degree: "MBA in Operations & Systems", year: "2018" },
    ],
    sampleSkills: ["Customer Success", "Enterprise Renewals", "Gainsight", "Churn Reduction", "Executive QBRs", "Upselling"],
  },

  {
    ...
    sampleEducation: [
      { institution: "IIT Madras", degree: "B.Tech in Computer Science", year: "2016" },
    ],
    sampleSkills: ["Golang", "Rust", "Distributed Systems", "Raft Consensus", "Redis", "Kafka", "Linux Networking"],
  },

  {
    ...
    sampleEducation: [
      { institution: "RVCE Bengaluru", degree: "B.E. in Computer Science · 9.35 CGPA", year: "2023" },
    ],
    sampleSkills: ["C++", "Java", "Data Structures & Algorithms", "Python", "SQL", "OOP", "Git"],
  },

  // ---------------------------------------------------------------------------
  // 51 - 60: Expanded High-Performance & Specialized Domain Templates
  // ---------------------------------------------------------------------------
  {
    id: "kite",
    name: "Kite",
    ...
    sampleEducation: [
      { institution: "NIT Calicut", degree: "B.Tech in Computer Science", year: "2016" },
    ],
    sampleSkills: ["eBPF", "Go", "Linux Internals", "PostgreSQL", "Kubernetes", "WebSockets"],
  },

  {
    ...
    sampleEducation: [
      { institution: "IIM Lucknow", degree: "PGDM in Marketing & Strategy", year: "2014" },
    ],
    sampleSkills: ["Channel Alliances", "Global Enterprise Sales", "Contract Negotiation", "Partner Ecosystems", "MEDDPICC"],
  },

  {
    ...
    sampleEducation: [
      { institution: "IIT Bombay", degree: "B.Tech + M.Tech in Electrical Eng (Dual Degree)", year: "2015" },
    ],
    sampleSkills: ["C++20", "Python / Cython", "Quantitative Alpha", "Options Pricing", "Time-Series Econometrics", "Statistical Arbitrage"],
  },

  {
    ...
    sampleEducation: [
      { institution: "PICT Pune", degree: "B.E. in Information Technology · 9.24 CGPA", year: "2023" },
    ],
    sampleSkills: ["React", "TypeScript", "Node.js", "Express", "Docker", "PostgreSQL", "Tailwind CSS"],
  },

  {
    ...
    layoutStyle: "sidebar-right",
    accentColor: "#0F766E",
    sampleMetrics: ["+64% PLG Signups", "₹22Cr ARR"],
    ...
    sampleEducation: [
      { institution: "ISB Hyderabad", degree: "Post Graduate Programme in Management (MBA)", year: "2017" },
    ],
    sampleSkills: ["Product-Led Growth", "Monetization Funnels", "Pricing Strategy", "A/B Testing", "Mixpanel", "SQL"],
  },

  {
    ...
    sampleEducation: [
      { institution: "Srishti Institute of Art & Design", degree: "B.Des in Digital Experience", year: "2018" },
    ],
    sampleSkills: ["Design Systems", "Figma Variables & Tokens", "WCAG Accessibility", "Prototyping", "Storybook", "React Basics"],
  },

  {
    ...
    sampleEducation: [
      { institution: "MICA Ahmedabad", degree: "PGDM in Brand Management", year: "2017" },
    ],
    sampleSkills: ["Performance Marketing", "Quick Commerce Growth", "MoEngage / Clevertap", "Attribution Modeling", "Meta Ads", "CAC Optimization"],
  },

  {
    ...
    sampleEducation: [
      { institution: "IIM Ahmedabad", degree: "Post Graduate Programme in Management (MBA)", year: "2006" },
    ],
    sampleSkills: ["P&L Responsibility", "Enterprise B2B Strategy", "MSME Ecosystems", "Board Governance", "M&A Integration"],
  },

  {
    ...
    sampleEducation: [
      { institution: "IIT Madras", degree: "B.Tech in Computer Science & Engineering", year: "2007" },
    ],
    sampleSkills: ["Multi-Cloud Architecture", "AWS & Azure Certified Fellow", "Enterprise Governance", "Legacy Modernization", "Financial Cloud Compliance"],
  },

  {
    ...
    sampleEducation: [
      { institution: "IIT Delhi", degree: "B.Tech in Computer Science", year: "2019" },
    ],
    sampleSkills: ["Indic LLMs", "PyTorch", "vLLM", "LoRA / QLoRA", "Hugging Face", "CUDA C++", "Whisper ASR"],
  },
];
